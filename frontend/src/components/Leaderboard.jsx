    ...
    const fetchLeaderboard = async () => {
      try {
        ...
        const rankResponse = await axios.get(
          `${apiUrl}/api/leaderboard/rank/${user.telegramId}`
        )
      ...
      <div className="card">
        ...
        {leaderboard.map((player, index) => (
          <div
            ...
            style={{
              background: player.telegramId === user.telegramId ? '#f0f9ff' : 'transparent',
              borderRadius: '8px',
              padding: '10px',
              margin: '5px 0'
            }}
          >
            ...
            <div className="user-info">
              <div className="username">{player.firstName}</div>
